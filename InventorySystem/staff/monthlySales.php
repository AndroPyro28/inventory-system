                ...
                <ul class="nav-links">
                    ...
                    <li class="dropdown open">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="active"><a href="monthlySales.php"><i class="fas fa-calendar-check"></i>Monthly Sales</a></li>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class="total-row">
                                    ...
                                    <td colspan="2"><strong>₱76,000.00</strong></td>
                                </tr>
                                <tr class="profit-row">
                                    <td colspan="2"><strong>Total Profit</strong></td>
                                    <td colspan="3"><strong>₱22,800.00</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
