                    ...
                    <form id="addProductForm" class="product-form">
                        ...
                        <div class="numeric-inputs">
                            <div class="input-group">
                                ...
                                <input type="number" id="quantity" placeholder="Product Quantity" min="1" step="1" required>
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="buyingPrice" placeholder="Buying Price" min="0.01" step="0.01" required>
                                <div class="spinner-buttons">
                                    <button type="button" class="spinner-up"><i class="fas fa-chevron-up"></i></button>
                                    <button type="button" class="spinner-down"><i class="fas fa-chevron-down"></i></button>
                                </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="sellingPrice" placeholder="Selling Price" min="0.01" step="0.01" required>
                                <div class="spinner-buttons">
                                    <button type="button" class="spinner-up"><i class="fas fa-chevron-up"></i></button>
                                    <button type="button" class="spinner-down"><i class="fas fa-chevron-down"></i></button>
                                </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', (e) => {
                    ...
                    if (isValid) {
                        ...
                        messageBox.textContent = 'Please correct the errors before submitting.';
