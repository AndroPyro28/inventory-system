                    ...
                    <div id="editSaleSection">
                        ...
                        <div class="table-container">
                            <table>
                                ...
                                <tbody>
                                    <tr id="saleDataRow">
                                        <td><input type="text" class="editable-input item-input" value="Art Canvas Set"></td>
                                        <td><input type="number" class="editable-input price-input" value="350.00"></td>
                                        <td><input type="number" class="editable-input qty-input" value="1"></td>
                                        <td><span class="total-amount">₱350.00</span></td>
                                        <td>
                                            <div class="date-picker-container">
                                                <input type="text" class="date-input" value="2024-03-20">
                                        ...
                                        <td>
                                            <button class="update-sale-btn" disabled>Update Sale</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                calendarBtn.addEventListener('click', () => {
                    const datePickerInput = document.createElement('input');
                    datePickerInput.type = 'date';
                    datePickerInput.value = document.querySelector('.date-input').value;
