                ...
                <div class="settings-container">
                    ...
                    <div class="settings-table">
                        ...
                        <div class="photo-content">
                            <img src="../upload/ArtMore.jpg" alt="Current Photo" id="currentPhoto">
                            <div class="photo-actions">
                                <input type="file" id="photoInput" accept="image/*" style="display: none;">
                                <button class="btn-choose" onclick="document.getElementById('photoInput').click()">
                                    Choose Image
                                </button>
                    ...
                    <div class="settings-table">
                        ...
                        <div class="account-content">
                            <div class="input-group">
                                <input type="text" value="Carlos Miguel B. Ochia">
                                <label>Name</label>
                            </div>
                            <div class="input-group">
                            ...
                            <div class="button-group">
                                ...
                                <button class="btn-change-password" onclick="window.location.href='changePassword.php'">Change Password</button>
                            </div>
                        </div>
                    </div>
                </div>
