                    ...
                    <div class="content-card dashboard-table" style="flex: 1; height: 300px; display: flex; flex-direction: column;">
                        ...
                        <div class="table-container" style="padding: 20px; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
                            <div>
                                ...
                                <input type="text" id="categoryName" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid rgba(255, 255, 255, 0.1); background-color: rgba(30, 30, 30, 0.8); color: #AEB2B7; font-family: 'Century Gothic', sans-serif;">
                            </div>
                            <button class="add-btn" style="width: 100%;">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                deleteButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (confirmDelete) {
                            ...
                            // Here you would typically also make an API call to delete from the database
                        }
                    });
                });
                ...
                editButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        // Navigate to editCategory.php with parameters
                        window.location.href = `editCategory.php?id=${categoryId}&name=${encodeURIComponent(categoryName)}`;
                    });
                });

                // Add Category Functionality
                const addCategoryBtn = document.querySelector('.add-btn');
                ...
                addCategoryBtn.addEventListener('click', function() {
                    ...
                    // Here you would typically make an API call to add to the database
                    // For now, we'll just show a success message and clear the input
                    alert('Category Added Successfully');
                    categoryNameInput.value = ''; // Clear the input field
                    
                    // Optionally, you can also add the new category to the table immediately
                    ...
                    const newEditBtn = newRow.querySelector('.edit');
                    const newDeleteBtn = newRow.querySelector('.delete');
                    
                    newEditBtn.addEventListener('click', function() {
                        window.location.href = `editCategory.php?id=${nextId}&name=${encodeURIComponent(categoryName)}`;
                    });
